...
public class UserServiceImpl implements UserService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        pl.kedzierski.gameshop.models.User user = userRepository.findByUsername(username);
        if (user == null) {
    ...
    private UserDetails createUserDetails(pl.kedzierski.gameshop.models.User user) {
    ...
    @Override
    public void save(pl.kedzierski.gameshop.models.User user) {
